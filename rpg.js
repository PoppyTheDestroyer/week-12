...
var jason = new character("Jason", "Professional at being Awesome", "male", 36, 100, 100)
...
function attack(attacker, defender) {
    ...
    console.log(attacker.name + " attacked " + defender.name + " for " + attacker.strength + " damage! " + defender.name + " now has " + defender.hitPoints + " hitpoints.")
};
